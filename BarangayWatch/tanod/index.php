                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Welcome Tanod</h1>
                                </div>
                                <form class="user" method="POST" action="tanodlogin.php">
                                    ...
                                    <?php 
                                        session_start();
                                        if(ISSET($_SESSION['tanod_message'])){
                                            echo"<div class='alert alert-danger text-center'>";
                                            echo "<span'>".$_SESSION['tanod_message']."</span>";
                                            echo "</div>";
                                        }
                                    ?>
                                ...
                                <div class="text-center">
                                    <a class="small" href="tanodsignup.php">Create an Account!</a>
                                </div>
                            </div>
                        </div>
                    </div>
