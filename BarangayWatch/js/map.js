    ...
    if (navigator.geolocation) {
        ...
        fetch(geocodeAPI)
            ...
            .then(data => {
				...
				document.getElementById("address").setAttribute("class", "alert alert-success");
                document.getElementById("address").innerText = 'Address: ' + data.display_name;
                document.getElementById("submit-report").removeAttribute("disabled", "disabled");
                document.getElementById("user_add").value=data.display_name;
            })
