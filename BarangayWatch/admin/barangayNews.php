						...
						<div class="col-lg-4">
							<div class="col-lg-12 p-4">
								<div class="card card-body bg-light">
									<h6>POST NEWS & UPDATE</h6>
									<form class="mt-3" method="POST" action="addNews.php">
										...
										<div class="form-group">
											<textarea rows="10" style="resize:none;" class="form-control" name="post" placeholder="Enter your text here...." required="required"></textarea>
										</div>
										<div class="form-group d-flex justify-content-center">
											<button class="btn btn-primary" type="submit" name="postButton">POST</button>
										</div>
									</form>
								</div>
							</div>
