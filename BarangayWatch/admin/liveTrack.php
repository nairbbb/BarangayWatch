        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
					<div class="alert alert-primary">LIVE TRACK</div>
					
					<div class="row p-5">
						<div class="col-lg-12">
							<div class="row">
								<div class="col-lg-6 border">
									<canvas id="recordCanvas"style="height:350px; width:100%;"></canvas>
								</div>
								<div class="col-lg-6">
						...
						<div><button class="btn btn-sm btn-primary" id="detectButton">Activate Detection</button></div>
						<div class="col-lg-12"></div>
						<div class="col-lg-4 card mt-5 p-3">
								<div class="col-lg-12">
								<!--<a class="dropdown-item" href="#" data-toggle="modal" data-target="#alertModal">
                                    <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Alert
                                </a>-->
								<h3>Incident List</h3>
								<hr />
								<ul class="list-group list-group-flush" id="incident_holder">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
					<h1 class="text-danger text-center">ALERT</h1>
					<hr />
					<p class="text-center">PLEASE CHECK THE CCTV FOOTAGE ON CAM 1</p>
				</div>
            </div>
        </div>
    </div>
